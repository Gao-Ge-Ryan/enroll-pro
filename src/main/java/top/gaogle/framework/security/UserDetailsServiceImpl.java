...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        List<RoleModel> roleModels = roleMapper.queryRoleByAccountBy(userModel.getUsername());
        ...
        EnterpriseModel enterpriseModel = enterpriseMapper.queryByAccountByAndStatus(username, EnterpriseStatusEnum.APPROVED);
