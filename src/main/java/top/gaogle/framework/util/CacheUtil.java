...
public class CacheUtil {
    ...
    public boolean tokenCache(String token) {
        ...
        stringRedisTemplate.opsForValue().set(StringUtil.redisKey("user", "token", base64), base64, RegisterConst.AUTHENTICATION_EXPIRATION_HOURS, TimeUnit.HOURS);
    ...
    public boolean distributedLock(String key, String value, long timeout, TimeUnit unit) {
