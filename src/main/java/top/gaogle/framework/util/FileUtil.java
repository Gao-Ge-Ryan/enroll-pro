...
public class FileUtil {
    ...
    static {
        ...
        fileTypeMap.put("255044462d312", "pdf");
        ...
        // JPEG (jpg/jpeg)
        fileTypeMap.put("ffd8ffe000104a464946", "jpg");  // Standard JPEG
        fileTypeMap.put("ffd8ffe1", "jpg");            // JPEG with EXIF
        fileTypeMap.put("ffd8ffe2", "jpg");            // JPEG with Canon EOS
        fileTypeMap.put("ffd8ffe3", "jpg");            // Other JPEG variants
        fileTypeMap.put("ffd8ffe8", "jpg");            // Still Picture Interchange File Format (SPIFF)
        fileTypeMap.put("ffd8ffe0", "jpeg");           // Another common signature for JPEG

        // WebP
        fileTypeMap.put("52494646", "webp");           // RIFF header for WebP files
        fileTypeMap.put("57454250", "webp");           // WEBP signature

        // GIF
        fileTypeMap.put("474946383961", "gif");        // GIF89a
        fileTypeMap.put("474946383761", "gif");        // GIF87a

        // SVG
        fileTypeMap.put("3c3f786d6c2076", "svg");  // XML declaration for SVG
        fileTypeMap.put("3c73766720", "svg");                  // <svg tag
        fileTypeMap.put("3c7376673e", "svg");                 // <svg> tag
    }
    ...
    public static void response2Json(HttpServletResponse response, String message) {
        try {
//            response.setContentType("application/json");
            ...
            result.failedBadRequest().setMessage(message);
