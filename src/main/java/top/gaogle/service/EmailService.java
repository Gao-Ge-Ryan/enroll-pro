...
public class EmailService extends SuperService {
    ...
    public I18nResult<Boolean> sendText(String to, String subject, String content) {
        return this.send(GaogleConfig.getSystemName(), platformMail, to, subject, content, false, null, null, null);
    }

    public I18nResult<Boolean> sendHTML(String to, String subject, String content) {
        return this.send(GaogleConfig.getSystemName(), platformMail, to, subject, content, true, null, null, null);
    }
