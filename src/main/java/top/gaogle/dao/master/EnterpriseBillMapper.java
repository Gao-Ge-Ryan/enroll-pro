...
public interface EnterpriseBillMapper {
    ...
    int updateBalanceAndStatusAddByBillId(String enterpriseBillId, Long amount, BillStatusEnum status, String tradeStatus, String tradeNo, Long completionAt);
    
    int updateBalanceAndStatusSubtractByBillId(String enterpriseBillId, Long amount, BillStatusEnum status,  Long completionAt);
